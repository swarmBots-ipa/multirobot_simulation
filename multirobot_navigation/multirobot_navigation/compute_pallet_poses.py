...
class ComputeEdgePose(Node):
    ...
    def compute_pallet_edge(self, pose, center_angle, width, height):
        ...
        self.set_pose_A(aX, aY, orientation_z, orientation_w)
        self.set_pose_B(bX, bY, orientation_z, orientation_w)
        self.set_pose_C(cX, cY, orientation_z, orientation_w)
        self.set_pose_D(dX, dY, orientation_z, orientation_w)
